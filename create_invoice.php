               ...
               <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                     <div class="form-group mt-3 mb-3 ">
                        ...
                        <div class="input-group mb-3">
                           <div class="input-group-prepend">
                              <span class="input-group-text currency">Tax percentage % </span>
                           </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                     <div class="form-group">
                        ...
                        <input disabled data-loading-text="Saving Invoice..." type="submit" id="invoice_btn" name="invoice_btn" value="Save Invoice" class="btn btn-success submit_btn invoice-save-btm">
                     </div>
                  </div>
               </div>
