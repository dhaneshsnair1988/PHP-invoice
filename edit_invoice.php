		      		...
		      		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		      			<table class="table table-condensed table-striped" id="invoiceItem">	
							...
							<tr>
								...
								<input type="hidden" value="<?php echo $invoiceItem['order_id']; ?>" class="form-control" name="itemId[]">
							</tr>	
							<?php } ?>		
						</table>
		      		</div>
						...
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group-prepend">
									<span class="input-group-text">tax percentage %</span>
								</div>
							<select class="form-select form-control" aria-label="Tax rate" id="taxRate" name="taxRate">
                              <option value="0" <?php if ( $invoiceValues['order_tax_per']==0){echo "selected";}?>>0  </option>
							  <option value="1" <?php if ( $invoiceValues['order_tax_per']==1){echo "selected";}?>>1  </option>
                              <option value="5" <?php if ( $invoiceValues['order_tax_per']==5){echo "selected";}?>>5  </option>
                              <option value="10" <?php if ( $invoiceValues['order_tax_per']==10){echo "selected";}?>>10 </option>
                            </select>
								</div>
							</div>
						</div>
